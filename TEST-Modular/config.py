...
class SimConfig:
    ...
    # 【新增】终端交互控制
    ENABLE_CLI_SETUP = 1  # True(或1): 开启终端交互放车; False(或0): 直接运行
    ...
    PLC_MIN_MSS_MULT = 1.2  # 变道跑道锁下限 (需要 1.8 倍 MSS 空间才准打方向盘)
    ...
    COOLDOWN_LANE_CHANGE = 5  # 成功变道后的策略冷却帧数
